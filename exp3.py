...
#                          [0, 0, 0, 1]])
#calculate_q(initial_position, goal_position, 'exp3_1', 10)

move_to_position('exp3_1', 10)
...
#                    [0, 0, 0, 1]])
#calculate_q(initial_position, goal_position, 'exp3_2', 5)

move_to_position('exp3_2', 5)
...
#                          [0.05798, -0.998,-0.02681, 0.4007],
#                          [0, 0, 0, 1]])
#calculate_q(initial_position, goal_position, 'exp3_3', 5)

move_to_position('exp3_3', 5)

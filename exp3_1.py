...
filepath = r"experiment_data_set\figures\exp3_control_and_state_variables.png"
...
goal_position = np.array([[0.0305, -0.9993, 0.02121, 0.6728],
                   ...
                   [0, 0, 0, 1]])
calculate_q(initial_position, goal_position, 'exp3_1_1', 3, filepath, factor = 10)

# move_to_position('exp3_1_1', 3)

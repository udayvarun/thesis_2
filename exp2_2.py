...
goal_position = np.array([[0.0383, -0.02461, 0.999, 0.9191],
                         ...
                         [0, 0, 0, 1]])
calculate_q(initial_position, goal_position, 'exp2_2_1', 10, 6)
...
goal_position = np.array([[0.9996, 0.02393, -0.01562, 0.5821],
                         ...
                         [0, 0, 0, 1]])
calculate_q(initial_position, goal_position, 'exp2_2_2', 5, 6)
...
goal_position = np.array([[0.0383, -0.02461, 0.999, 0.9191],
                         ...
                         [0.05798, -0.998,-0.02681, 0.4007],
                         [0, 0, 0, 1]])
calculate_q(initial_position, goal_position, 'exp2_2_3', 5, 6)
